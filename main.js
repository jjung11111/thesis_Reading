...
//get initialize loading variables
var loaded = false;
var load_counter = 0;
...
var mountain3 = new Image();
var mountain4 = new Image();
...
function drawCanvas() {
	...
	var rotate_x = (pointer.y * -0.2) + (motion.y * -1.2);
	var rotate_y = (pointer.x * 0.2) + (motion.x * 1.2);
